...
class App(QMainWindow):
    ...
    def initUI(self):
        ...
        embed = "<iframe width='100%' height='100%' src='{}' frameborder='0' scrollbar='no' allow='accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture' allowfullscreen></iframe>".format(spaceXlaunch.fixedLink)
